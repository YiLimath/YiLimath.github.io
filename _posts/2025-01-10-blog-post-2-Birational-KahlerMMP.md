...
[Note-11 Existence of Minimal Models and Good Minimal Models in the Kähler Setting](https://yilimath.github.io/files/Birational/KahlerMMP/ExistMM.pdf) [TODO]
...
Note-13 Canonical Bundle Formulas and Subadjunction with Applications in the Kähler MMP *(in preparation)*

Note-14 Abundance for Kähler Threefolds *(in preparation)*

Note-15 Applications of the Kähler MMP *(in preparation)*

[Note-16 On the Kähler 3-Fold and 4-Fold MMP](https://yilimath.github.io/files/Birational/KahlerMMP/Kahler4foldMMP.pdf) [TODO]
