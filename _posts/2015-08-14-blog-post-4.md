...
We have $$\overline{A^{q, p}(X)}=A^{p, q}(X)$$and therefore $$\overline{\text{Fil}^q A^h(X)}={ }^{\prime \prime} \text{Fil}^q A^h(X)$$As a consequence we also has $$\overline{\text{Fil}^q H^h(X)}={ }^{\prime \prime} \text{Fil}^q H^h(X) .$$
