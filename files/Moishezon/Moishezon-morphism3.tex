...
\begin{document}
	...
	Assume now that $S$ is reduced. A proper morphism of analytic spaces $g: X \rightarrow S$ is Moishezon if $g: X \rightarrow S$ is bimeromorphic to a projective morphism $g^{\mathrm{p}}: X^{\mathrm{p}} \rightarrow$ $S$. 
