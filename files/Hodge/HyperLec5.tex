...
\begin{document}
	...
	\section{Overview}
	In today's lecture we will finish our discussion on the period domain and period mapping
	
	\section{More consequences about curvature property}
	
	\subsection{Flat (p,q) theorem}
	
	\subsection{Rigidity of the variational Hodge structure}
	
	\section{Geometry and fundamental group representation}
